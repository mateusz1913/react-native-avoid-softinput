...
If your bottom sheet implementation uses React Native `Modal` component, you should use `AvoidSoftInputView` component ([check Modal recipe](./recipes/recipes-modal)). Otherwise use `AvoidSoftInput` module like in the example below.
