...
class AvoidSoftInput: RCTEventEmitter {
    ...
    func setShowAnimationDuration(duration: NSNumber?) {
        ...
        private func sendAppliedOffsetChangedEvent(_ offset: CGFloat) {
            if hasListeners {
                sendEvent(
                    withName: AvoidSoftInputConstants.softInputAppliedOffsetChanged,
        ...
        private func sendHeightChangedEvent(_ height: CGFloat) {
            if hasListeners {
                sendEvent(
                    withName: AvoidSoftInputConstants.softInputHeightChanged,
        ...
        private func sendHiddenEvent(_ height: CGFloat) {
            if hasListeners {
                sendEvent(
                    withName: AvoidSoftInputConstants.softInputHidden,
                    body: [AvoidSoftInputConstants.softInputHeightKey: height]
                )
            }
        }
        ...
        private func sendShownEvent(_ height: CGFloat) {
            if hasListeners {
                sendEvent(
                    withName: AvoidSoftInputConstants.softInputShown,
                    body: [AvoidSoftInputConstants.softInputHeightKey: height]
                )
            }
        }
